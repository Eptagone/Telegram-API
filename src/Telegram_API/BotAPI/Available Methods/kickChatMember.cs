...
namespace TelegramAPI.Available_Methods
{
    public static partial class AvailableMethods
    {
        ...
        public static bool KickChatMember(this BotClient T, object chat_id, int user_id)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPC<bool>("kickChatMember", new JObject { new JProperty("chat_id", chat_id), new JProperty("user_id", user_id) });
        }
        ...
        public static bool KickChatMember(this BotClient T, object chat_id, int user_id, int until_date)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPC<bool>("kickChatMember", new JObject { new JProperty("chat_id", chat_id), new JProperty("user_id", user_id), new JProperty("until_date", until_date) });
        }
    }
}