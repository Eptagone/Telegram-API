...
namespace TelegramAPI.Available_Methods
{
    public static partial class AvailableMethods
    {
        ...
        public static Available_Types.ChatMember[] GetChatAdministrators(this BotClient T, object chat_id)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPC<Available_Types.ChatMember[]>("getChatAdministrators", new JObject { new JProperty("chat_id", chat_id) });
        }
    }
}