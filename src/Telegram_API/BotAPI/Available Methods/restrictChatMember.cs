...
namespace TelegramAPI.Available_Methods
{
    public static partial class AvailableMethods
    {
        ...
        public static bool RestrictChatMember(this BotClient T, object chat_id, int user_id, Available_Types.ChatPermissions permissions)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPC<bool>("restrictChatMember", new JObject { new JProperty("chat_id", chat_id), new JProperty("user_id", user_id), new JProperty("permissions", permissions) });
        }
        ...
        public static bool RestrictChatMember(this BotClient T, object chat_id, int user_id, Available_Types.ChatPermissions permissions, uint until_date)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPC<bool>("restrictChatMember", new JObject { new JProperty("chat_id", chat_id), new JProperty("user_id", user_id), new JProperty("permissions", permissions), new JProperty("until_date", until_date) });
        }
    }
}