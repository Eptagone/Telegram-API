...
namespace TelegramAPI.Stickers
{
    public static partial class StickersMethods
    {
        ...
        public static bool AddStickerToSet(this BotClient T, int user_id, string name, string png_sticker, string emojis)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPCF<bool>("addStickerToSet", new AddStickerToSetArgs { User_id = user_id, Name = name, Png_sticker = png_sticker, Emojis = emojis });
        }
        ...
        public static bool AddStickerToSet(this BotClient T, int user_id, string name, string png_sticker, string emojis, MaskPosition mask_position)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            return T.RPCF<bool>("addStickerToSet", new AddStickerToSetArgs { User_id = user_id, Name = name, Png_sticker = png_sticker, Emojis = emojis, Mask_position = mask_position });
        }
