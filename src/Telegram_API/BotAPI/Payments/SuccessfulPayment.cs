...
namespace TelegramAPI.Payments
{
    ...
    public sealed class SuccessfulPayment
    {
        ...
        [JsonProperty(PropertyName = "telegram_payment_charge_id", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public string Telegram_payment_charge_id { get; set; }
        /// <summary>Provider payment identifier.</summary>
        [JsonProperty(PropertyName = "provider_payment_charge_id", DefaultValueHandling = DefaultValueHandling.Ignore)]
