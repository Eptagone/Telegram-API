...
namespace Telegram.BotAPI
{
    ...
    public interface ITelegramBotAsync
    {
        ...
        public Task OnUpdate(Update update, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a message update.</summary>
        /// <param name="message">Message.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnMessage(Message message, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a edited message.</summary>
        /// <param name="message">Message</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnEditedMessage(Message message, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a channel post.</summary>
        /// <param name="message">Message</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnChannelPost(Message message, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a edited channel post update.</summary>
        /// <param name="message">Message</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnEditedChannelPost(Message message, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a inline query update.</summary>
        /// <param name="inlineQuery">Inline query.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnInlineQuery(InlineQuery inlineQuery, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a chosen inline result update.</summary>
        /// <param name="chosenInlineResult">Chosen Inline Result.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnChosenInlineResult(ChosenInlineResult chosenInlineResult, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a callback query update.</summary>
        /// <param name="callbackQuery">Callback query</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnCallbackQuery(CallbackQuery callbackQuery, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a shipping query update.</summary>
        /// <param name="shippingQuery">Shipping query</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnShippingQuery(ShippingQuery shippingQuery, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a pre-checkout query update.</summary>
        /// <param name="preCheckoutQuery">Pre-checkout query.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnPreCheckoutQuery(PreCheckoutQuery preCheckoutQuery, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a poll update.</summary>
        /// <param name="poll">Poll.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnPoll(Poll poll, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a poll answer update.</summary>
        /// <param name="pollAnswer">Poll answer.</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnPollAnswer(PollAnswer pollAnswer, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a bot exception.</summary>
        /// <param name="exp">Bot exception</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnBotException(BotRequestException exp, [Optional] CancellationToken cancellationToken);
        /// <summary>Instructions for a general exception.</summary>
        /// <param name="exp">Exception</param>
        /// <param name="cancellationToken">Optional. Cancelation Token.</param>
        /// <returns><see cref="Task"/></returns>
        public Task OnException(Exception exp, [Optional] CancellationToken cancellationToken);
    }
}
