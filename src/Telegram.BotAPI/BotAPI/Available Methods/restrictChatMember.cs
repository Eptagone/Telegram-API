...
namespace Telegram.BotAPI.Available_Methods
{
    public static partial class AvailableMethods
    {
        ...
        /// <param name="T">BotClient</param>
        /// <param name="args">Parameters</param>
        public static async Task<bool> RestrictChatMemberAsync(this BotClient T, RestrictChatMemberArgs args)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            if (args == default)
                throw new System.ArgumentNullException(nameof(args));
            return await T.RPCA<bool>("restrictChatMember", args).ConfigureAwait(false);
        }
        /// <summary>Use this method to restrict a user in a supergroup. The bot must be an administrator in the supergroup for this to work and must have the appropriate admin rights. Pass True for all boolean parameters to lift restrictions from a user. Returns True on success.</summary>
        /// <param name="T">BotClient</param>
        /// <param name="chat_id">Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername).</param>
        ...
        public static async Task<bool> RestrictChatMemberAsync(this BotClient T, object chat_id, int user_id, Available_Types.ChatPermissions permissions, [Optional] uint until_date)
        {
            if (T == default)
                throw new System.ArgumentNullException(nameof(T));
            var args = new RestrictChatMemberArgs
